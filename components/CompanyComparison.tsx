...
export function CompanyComparison({ companies }: ComparisonProps) {
    ...
    return (
        <div
            ...
            data-oid="verljri"
        >
            <div className="flex justify-between items-center mb-6" data-oid="a.e-5h-">
                <h3 className="text-xl font-semibold text-gray-900" data-oid="laa_e4o">
                    Şirket Karşılaştırması
                </h3>
                <div className="flex space-x-2" data-oid="b74.v3x">
            ...
            {/* Company Selection */}
            <div className="mb-6" data-oid="yz8_0ug">
                <h4 className="font-medium text-gray-900 mb-3" data-oid="p9h.twc">
                    Karşılaştırılacak Şirketler ({selectedCompanies.length}/4)
                </h4>
                <div className="flex flex-wrap gap-2 mb-4" data-oid="uky7qjd">
                    {selectedCompanies.map((company) => (
                        <div
                            ...
                            data-oid="lbxmj:w"
                        >
                            <span className="text-sm font-medium" data-oid="cuzdj.p">
                                {company.name}
                            </span>
                            <button
                ...
                <select
                    ...
                    data-oid="tmml_:v"
                >
                    <option value="" data-oid="2ayt0au">
                        Şirket seçin...
                    </option>
                    {companies
                        .filter((c) => !selectedCompanies.find((sc) => sc.rank === c.rank))
                        .map((company) => (
                            <option key={company.rank} value={company.rank} data-oid="lo..i7_">
                                {company.name}
                            </option>
                        ))}
                </select>
            ...
            {selectedCompanies.length > 0 && (
                <div className="space-y-4" data-oid="qc.y3ev">
                    <h4 className="font-medium text-gray-900" data-oid="n-q0mmz">
                    ...
                    {getComparisonData().map((item, index) => (
                        <div key={index} className="flex items-center space-x-4" data-oid="6etvn:1">
                            <div
                            ...
                            <div className="flex-1 flex items-center space-x-2" data-oid="q511l.r">
                                <div
            ...
            {selectedCompanies.length === 0 && (
                <div className="text-center py-8 text-gray-500" data-oid="nkek4zo">
                    <p data-oid="79298ep">Karşılaştırma yapmak için şirket seçin</p>
                </div>
            )}
        </div>
    );
